const questions = [
	...
	},
  {
		...
		options: [ 
			{id: 1, text: 'Sunucu Adı', correct: false,},
			{id: 2, text: 'Sunucu', correct: false,},
			{id: 3, text: 'Alan Adı', correct: true,},
			{id: 4, text: 'Alan', correct: false,},
		],
	},
	{
		id: 71,
		...
		options: [
			{ id: 1, text: 'Teslim Tarihi', correct: true,},
			{ id: 2, text: 'Teslim Töreni', correct: false,},
			{ id: 3, text: 'Teslim Etmek', correct: false,},
			{ id: 4, text: 'Teslim',correct: false,},
		],
	},
  {
		id: 72,
		...
		options: [ 
			...
			{id: 2, text: 'Kapanır Menü', correct: false,},
			{id: 3, text: 'Açılır Kapanır Menü', correct: true,},
	...
	},
  {
		...
		options: [ 
			{id: 1, text: 'Kapsülleme', correct: true,},
			{id: 2, text: 'Diziler', correct: false,},
			{id: 3, text: 'Değişkenler', correct: false,},
			{id: 4, text: 'Veriler', correct: false,},
		],
	},
  {
		id: 74,
		...
		options: [ 
			{id: 1, text: 'Hazine', correct: false,},
			{id: 2, text: 'Gömülü', correct: true,},
			{id: 3, text: 'Gömüsüz', correct: false,},
			{id: 4, text: 'Göm', correct: false,},
		],
	},
  {
		id: 75,
	...
	},
  {
		...
		options: [ 
			...
			{id: 2, text: 'Şifre', correct: false,},
			{id: 3, text: 'Şifresiz', correct: false,},
			{id: 4, text: 'Şifreleme', correct: true,},
		],
	},
  {
		id: 77,
		...
		options: [ 
			{id: 1, text: 'Çıkış', correct: false,},
			{id: 2, text: 'Giriş', correct: true,},
			{id: 3, text: 'İptal', correct: false,},
			{id: 4, text: 'Devam', correct: false,},
		],
	},
  {
		id: 78,
		...
		options: [ 
			{id: 1, text: 'Mimarlık', correct: false,},
			{id: 2, text: 'Mühendislik', correct: true,},
			{id: 3, text: 'Bilişim', correct: false,},
			{id: 4, text: 'Ressamlık', correct: false,},
		],
	},
  {
		id: 79,
		...
		options: [ 
			{id: 1, text: 'Hata Kodu', correct: true,},
			{id: 2, text: 'Doğru Kod', correct: false,},
			{id: 3, text: 'Eğri Kod', correct: false,},
			{id: 4, text: 'Kod', correct: false,},
		],
	},
  {
		id: 80,
		...
		options: [ 
			...
			{id: 2, text: 'Kontrol', correct: false,},
			{id: 3, text: 'Uygun', correct: false,},
			{id: 4, text: 'Uygulamak', correct: true,},
		],
	},
	{
		id: 81,
		...
		options: [
			{ id: 1, text: 'Beklemek', correct: false,},
			{ id: 2, text: 'Giriş', correct: false,},
			{ id: 3, text: 'Çıkış', correct: true,},
			{ id: 4, text: 'Durmak',correct: false,},
		],
	},
  {
		id: 82,
		...
		options: [ 
			{id: 1, text: 'Daraltmak', correct: false,},
			{id: 2, text: 'Genişletmek', correct: true,},
			{id: 3, text: 'Küçültmek', correct: false,},
	...
	},
  {
		...
		options: [ 
			{id: 1, text: 'İhraç', correct: true,},
			{id: 2, text: 'İthal', correct: false,},
			{id: 3, text: 'Kod', correct: false,},
			{id: 4, text: 'Eklenti', correct: false,},
		],
	},
  {
		id: 84,
		...
		options: [ 
			{id: 1, text: 'Çekmek', correct: true,},
			{id: 2, text: 'Kod', correct: false,},
			{id: 3, text: 'Yazılım', correct: false,},
			{id: 4, text: 'Yazılımcı', correct: false,},
		],
	},
  {
		...
		options: [ 
			{id: 1, text: 'Başlangıç', correct: false,},
			{id: 2, text: 'Başlangıç Seviyesi', correct: false,},
			{id: 3, text: 'Uzman', correct: true,},
			{id: 4, text: 'Çaylak', correct: false,},
		],
	},
  {
		id: 86,
		...
		options: [ 
			{id: 1, text: 'Başarı', correct: false,},
			{id: 2, text: 'Başarmak', correct: false,},
			{id: 3, text: 'Başarılı', correct: false,},
			{id: 4, text: 'Başarısız', correct: true,},
		],
	},
  {
		id: 87,
		...
		options: [ 
			{id: 1, text: 'Elenen Şık', correct: false,},
			{id: 2, text: 'Harika', correct: false,},
			{id: 3, text: 'Doğru', correct: false,},
			{id: 4, text: 'Hata', correct: true,},
		],
	},
  {
		id: 88,
		...
		options: [ 
			{id: 1, text: 'Kısayol Simgesi', correct: true,},
			{id: 2, text: 'Kısayol Uzantısı', correct: false,},
			{id: 3, text: 'Kısayol', correct: false,},
			{id: 4, text: 'Uzun Yol', correct: false,},
		],
	},
  {
		id: 89,
		...
		options: [ 
			{id: 1, text: 'Eklenti', correct: false,},
			{id: 2, text: 'Kısayol', correct: false,},
			{id: 3, text: 'Özellik', correct: true,},
			{id: 4, text: 'Klavye', correct: false,},
		],
	},
  {
		id: 90,
		...
		options: [ 
			{id: 1, text: 'Bırakmak', correct: false,},
			{id: 2, text: 'Satmak', correct: false,},
			{id: 3, text: 'Getirmek', correct: true,},
			{id: 4, text: 'ELENEN CEVAP', correct: false,},
		],
	},
  {
		id: 91,
		...
		options: [
			{ id: 1, text: 'Çap', correct: false,},
			{ id: 2, text: 'Metre', correct: false,},
			{ id: 3, text: 'Alan', correct: true,},
			{ id: 4, text: 'Türev',correct: false,},
		],
	},
  {
		id: 92,
		...
		options: [ 
			{id: 1, text: 'Dosya Eklentisi', correct: true,},
			{id: 2, text: 'Dosya Hatası', correct: false,},
			{id: 3, text: 'Dosya Kurtarma', correct: false,},
			{id: 4, text: 'Dosya Sorunu', correct: false,},
		],
	},
  {
		id: 93,
		...
		options: [ 
			{id: 1, text: 'Dosya Eksiltme', correct: false,},
			{id: 2, text: 'Dosya Kurtarma', correct: true,},
			{id: 3, text: 'Dosya', correct: false,},
			{id: 4, text: 'Dosya Hatası', correct: false,},
		],
	},
  {
		id: 94,
		...
		options: [ 
			{id: 1, text: 'Bozuk', correct: false,},
			{id: 2, text: 'Bozmak', correct: false,},
			{id: 3, text: 'Düzeltmek', correct: true,},
			{id: 4, text: 'Düz', correct: false,},
		],
	},
  {
		id: 95,
		...
		options: [ 
			{id: 1, text: 'Ev', correct: false,},
			{id: 2, text: 'Badana', correct: false,},
			{id: 3, text: 'Kapı', correct: false,},
			{id: 4, text: 'Çerçeve', correct: true,},
		],
	},
  {
		id: 96,
